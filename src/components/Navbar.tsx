          ...
          <div className="relative">
            ...
            {showNotifMenu && (
              <>
                ...
                />
                <div
                  className={`fixed top-14 left-3 right-3 sm:absolute sm:top-full sm:left-auto sm:right-0 sm:w-80 max-w-sm mx-auto rounded-2xl border shadow-2xl p-3.5 z-50 transition-all ${
